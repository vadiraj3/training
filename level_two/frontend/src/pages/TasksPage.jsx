		...
		<Container sx={{ py: 4 }}>
			...
			<Alert severity="info" sx={{ mb: 4 }}>
				<Typography variant="body1" component="div">
					...
					<br />
					Each task builds upon the previous one, introducing new concepts like
					nested objects, arrays, and complex data structures.
					<br />
					<strong>Instructions:</strong> Click on each task to see detailed
					requirements, MUI components to use, and hints.
					<br />
			...
			<Box sx={{ mb: 3 }}>
				...
				<Paper elevation={1} sx={{ p: 2, mb: 2 }}>
					<Typography variant="body2" component="div">
						...
						each task (e.g.,{' '}
						<code>import {'{'} getOrgUsers {'}'} from '../services/api'</code>
						)
						<br />
